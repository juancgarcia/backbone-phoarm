...
require([ 'jquery', 'backbone', 'views/Header', 'views/Home', 'views/List', 'views/About', 'backbone.subroute'],
  function($, Backbone, HeaderView, HomeView, ListView, AboutView, Subroute) {
